...
var require_use_sync_external_store_shim_development = __commonJS({
  "../node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React44 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is, useState4 = React44.useState, useEffect6 = React44.useEffect, useLayoutEffect3 = React44.useLayoutEffect, useDebugValue4 = React44.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "../node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React44 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is, useSyncExternalStore2 = shim.useSyncExternalStore, useRef7 = React44.useRef, useEffect6 = React44.useEffect, useMemo11 = React44.useMemo, useDebugValue4 = React44.useDebugValue;
...
// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/composeClasses/composeClasses.mjs
...
// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/useForkRef/useForkRef.mjs
...
// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/isHostComponent/isHostComponent.mjs
function isHostComponent(element) {
  return typeof element === "string";
}
var isHostComponent_default = isHostComponent;

// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/appendOwnerState/appendOwnerState.mjs
...
// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/extractEventHandlers/extractEventHandlers.mjs
...
// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/omitEventHandlers/omitEventHandlers.mjs
...
// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/mergeSlotProps/mergeSlotProps.mjs
...
// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/resolveComponentProps/resolveComponentProps.mjs
...
// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/useSlotProps/useSlotProps.mjs
...
// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/ClassNameGenerator/ClassNameGenerator.mjs
...
// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/generateUtilityClass/generateUtilityClass.mjs
...
// ../node_modules/@mui/x-tree-view/node_modules/@mui/utils/generateUtilityClasses/generateUtilityClasses.mjs
...
var TreeViewStyleContext = React35.createContext({
  classes: {},
  slots: {},
  slotProps: {}
});
...
var useTreeViewStyleContext = () => {
  return React35.useContext(TreeViewStyleContext);
};
...
var TreeViewContext = React36.createContext(null);
if (true)
  TreeViewContext.displayName = "TreeViewContext";
var useTreeViewContext = () => {
  const context = React36.useContext(TreeViewContext);
  if (context == null) {
    throw new Error(true ? "MUI X Tree View: Could not find the Tree View context. This happens when a component is rendered outside of a SimpleTreeView or RichTreeView parent component. Ensure your component is a child of a Tree View component. This can also happen if you are bundling multiple versions of the Tree View." : formatErrorMessage(190));
  }
  return context;
};
...
var useTreeViewBuildContext = (parameters) => {
  ...
  const runItemPlugins = React37.useCallback((itemPluginProps) => {
  ...
  const wrapItem = React37.useCallback(({
    itemId,
    children,
    idAttribute
  }) => {
...
function TreeViewProvider(props) {
  ...
  const styleContextValue = React38.useMemo(() => ({
    classes,
    slots: {
  ...
  return (0, import_jsx_runtime19.jsx)(TreeViewContext.Provider, {
    value: contextValue,
    children: (0, import_jsx_runtime19.jsx)(TreeViewStyleContext.Provider, {
...
var TreeViewItemDepthContext = React39.createContext(() => -1);
if (true)
...
var reactMajor_default = parseInt(React40.version, 10);
...
var treeIdSelector = createSelector2((state) => state.providedTreeId ?? state.treeId);
var idSelectors = {
  /**
...
function buildItemsLookups(parameters) {
  ...
  const processItem = (item) => {
    ...
    if (label == null) {
      throw new Error(true ? `MUI X Tree View: All items must have a \`label\` property. You can use the \`getItemLabel\` prop to specify a custom label for each item. An item was provided without a label: ${JSON.stringify(item)}` : formatErrorMessage(192, JSON.stringify(item)));
    }
...
function checkId({
  ...
  if (id == null) {
    throw new Error(true ? `MUI X Tree View: All items must have a unique \`id\` property. You can use the \`getItemId\` prop to specify a custom id for each item. An item was provided without an id: ${JSON.stringify(item)}` : formatErrorMessage(193, JSON.stringify(item)));
  }
  ...
  itemMetaLookup[id] != null && itemMetaLookup[id].parentId !== parentId) {
    throw new Error(true ? `MUI X Tree View: All items must have a unique \`id\` property. The id "${id}" is used by multiple items. Use the \`getItemId\` prop to specify a custom id for each item if needed.` : formatErrorMessage(194, id));
  }
}
...
var itemsSelectors = {
   ...
   */
  itemMeta: createSelector2((state, itemId) => state.itemMetaLookup[itemId ?? TREE_VIEW_ROOT_PARENT_ID] ?? null),
  /**
   * Gets the ordered children ids of an item.
   */
  itemOrderedChildrenIds: createSelector2((state, itemId) => state.itemOrderedChildrenIdsLookup[itemId ?? TREE_VIEW_ROOT_PARENT_ID] ?? EMPTY_CHILDREN),
  /**
   ...
   */
  itemHeight: createSelector2((state) => state.itemHeight)
};
...
var expansionSelectors = {
   ...
   */
  isItemExpandable: createSelector2(itemsSelectors.itemMeta, (itemMeta, _itemId) => (itemMeta == null ? void 0 : itemMeta.expandable) ?? false)
};
...
var getNonDisabledItemsInRange = (state, itemAId, itemBId) => {
  const getNextItem = (itemId) => {
    ...
    throw new Error(true ? "MUI X Tree View: Invalid range - unable to find a path between the two items. This may occur if the items are not in the same tree or the tree structure is invalid. Verify that both items exist in the tree." : formatErrorMessage(191));
  };
...
@mui/system/esm/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-F3YX4MWX.js.map
